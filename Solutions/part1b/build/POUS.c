...
void PART1B_init__(PART1B *data__, BOOL retain) {
...
// Code part
void PART1B_body__(PART1B *data__) {
  // Initialise TEMP variables
  ...
  __SET_VAR(data__->,OUTPUT0,,(!(__GET_VAR(data__->OSCILLATOR,)) && __GET_VAR(data__->INPUT0,)));
